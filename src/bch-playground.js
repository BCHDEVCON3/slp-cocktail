...
const copyDeep = (t) => JSON.parse(JSON.stringify(t));
...
window.joincoin = async () => {
  try {
    ...
    transactionBuilder2.transaction.inputs[0] =
      transactionBuilder1.transaction.inputs[0];
    transactionBuilder2.transaction.inputs[1] =
      transactionBuilder1.transaction.inputs[1];
